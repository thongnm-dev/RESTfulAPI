...
namespace RESTfulAPI.Services
{
	public class AddressApiService : IAddressApiService
	{
        ...
        public async Task<IList<AddressDto>> GetAddressesByCustomerIdAsync(int customerId)
        {
            ...
            var key = _cacheManager.PrepareKeyForShortTermCache(RESTfulAPICustomerServicesDefaults.CustomerAddressesCacheKey, customerId);
		...
		public async Task<AddressDto> GetCustomerAddressAsync(int customerId, int addressId)
        {
            ...
            var key = _cacheManager.PrepareKeyForShortTermCache(RESTfulAPICustomerServicesDefaults.CustomerAddressCacheKey, customerId, addressId);

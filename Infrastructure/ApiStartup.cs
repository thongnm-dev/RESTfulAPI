...
using RESTfulAPI.Authorization.Policies;
using RESTfulAPI.Authorization.Requirements;
using RESTfulAPI.Configuration;
using RESTfulAPI.Delta;
using RESTfulAPI.Web.Framework.Infrastructure.Extensions;
...
namespace RESTfulAPI.Infrastructure
{
	...
	public class ApiStartup : IRESTfulAPIStartup
	{
		public void ConfigureServices(IServiceCollection services, IConfiguration configuration)
		{
			...
			services.Configure<MvcNewtonsoftJsoRESTfulAPItions>(options =>
			{
			...
			{
				// api description >>
				options.SwaggerDoc("v1", new OpenApiInfo { Title = "RESTfulAPI API", Version = "v1" });
				// auth definition >>
				...
				// TODO: options.UseAllOfToExtendReferenceSchemas(); // https://github.com/stepanbenes/api-for-RESTfulAPIcommerce/issues/16
			});
				...
				a =>
				{
					...
					// swagger configuration
					{
						...
						a.UseSwaggerUI(c =>
						{
							...
							c.SwaggerEndpoint("/api/swagger/v1/swagger.json", "RESTfulAPI v4.40");

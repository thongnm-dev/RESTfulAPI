...
using RESTfulAPI.Core.Domain.Media;
			...
			Product product)
		{
			...
			if (productAttributeValue != null)
			{
				...
				if (productAttributeValue.PictureId > 0)
				{
					...
					// This is needed since if you delete the product picture mapping from the RESTfulAPICommerce administrationthe
